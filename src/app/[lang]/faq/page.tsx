...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: ar
      ? 'المقاسات والتوصيل والإرجاع والتعديلات والعناية — أكثر ما يُسأل عنه في ميرت.'
  ...
  ar: [
    ...
    },
    {
      ...
      items: [
        ...
        ['هل تُعيدون توفير القطع؟', 'قطع الفهرس تُقصّ كل عام من الباترونات نفسها، لذا تعود. أما القطع الموسمية وقطع العروض فلا يُعاد قصّها بعد نفاد كميتها.'],
      ],
    },
    {
      id: 'returns',
    ...
    },
    {
      ...
      items: [
        ...
        ['هل تُصلحون القطع؟', 'نعم. يمكن إحضار أي قطعة من ميرت أو إرسالها إلى المتجر الرئيسي في الرياض لإصلاحها بسعر التكلفة — رتق النسيج، أو إعادة حياكة طرف الكُمّ، أو استبدال البطانة. ولا حدّ زمنيًا لذلك.'],
