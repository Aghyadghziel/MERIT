...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: ar
      ? 'مُدد التوصيل وتكاليفه داخل السعودية ودول الخليج وبقية العالم، وطريقة الإرجاع في ميرت.'
...
const COPY = {
  ...
  ar: {
    ...
    facts: [
      ...
      { label: 'استرداد المبلغ', value: '7', unit: 'أيام', note: 'أيام عمل على الأكثر، وغالبًا من 5 إلى 7، إلى البطاقة التي دُفع بها.' },
    ],
        ...
        <>
          ...
          <Section id="alterations" title={title(3)}>
            <p>
              ...
              ذلك. ويمكن إرسال أي قطعة من ميرت لإصلاحها في أي وقت من عمرها. ولا يمكن إرجاع القطع المعدَّلة.
            </p>
          </Section>
