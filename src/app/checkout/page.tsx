...
export const metadata: Metadata = {
  title: 'Checkout',
  description: 'MERIT is a concept site. There is no payment processor, and nothing can be bought.',
      ...
      <div className="page grid-page min-h-[calc(100svh-var(--nav-h))] content-start gap-y-14 pb-(--section) pt-[clamp(2.75rem,1rem+5vw,7rem)]">
        <div className="col-span-4 md:col-span-6 lg:col-span-7">
          <div className="flex items-center gap-4" data-reveal>
            ...
            <p className="label text-mute-ink">A concept site</p>
          </div>

          <h1 id="checkout-title" className="display-xl mt-8 max-w-[11ch]">
            <MaskHeadline text="Nothing here can be bought." />
          </h1>
