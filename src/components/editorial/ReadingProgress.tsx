 ...
 * first line of the text to the last, not the length of the page. It is a
...
export function ReadingProgress({ target }: { target: string }) {
  ...
  return (
    <div
      ...
      className="pointer-events-none fixed inset-x-0 top-[var(--header-offset,var(--nav-h))] z-40 h-[2px] origin-left bg-bone mix-blend-difference transition-[top] duration-500 ease-[cubic-bezier(.16,1,.3,1)]"
    />
  );
}
