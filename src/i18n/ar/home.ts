...
export const home: Record<string, string> = {
  ...
  'Try on': 'جرّبها',
  Wearing: 'يرتدي',
  'Tap to swap': 'المس للتبديل',
  Wear: 'ارتدِ',
  Swap: 'بدّل',
  'Wear it': 'ارتدِها',
  'On the model': 'على العارض',
  'Fitting Room': 'غرفة القياس',
  'The Fitting Room': 'غرفة القياس',
  'Choose a jacket': 'اختر سترة',
  'Tap a jacket': 'المس سترة',
  'Jacket taken off. Now wearing the {name}.': 'خُلعت السترة. يرتدي الآن {name}.',
  'Now wearing the {name} in {colour}.': 'يرتدي الآن {name} باللون ال{colour}.',
  'Now wearing': 'يرتدي الآن',
  'Size, {name}': 'المقاس، {name}',
  'Size {size}, unavailable': 'المقاس {size}، غير متوفّر',
  'Size {size}': 'المقاس {size}',
  'Choose a size': 'اختر المقاس',
  'Only a few left in {size}': 'بقيت قطع قليلة بمقاس {size}',
  ...
  'Set flat, on the left breast.': 'مسطّح، على الجهة اليسرى من الصدر.',
  'Two-way zip': 'سحّاب باتجاهين',
  'Opens from the hem when you sit.': 'يُفتح من الأسفل حين تجلس.',
  'Bonded cotton twill, 300g': 'تويل قطني مُلصق، 300 غ',
  'Holds its shape without padding.': 'يحفظ شكله دون حشو.',
  'Elasticated cuff': 'كُمّ مطّاطي',
  'Hem and cuff close on the body.': 'الحافة والكُمّ ينغلقان على الجسم.',
  'Shirt collar': 'ياقة قميص',
  'Lies flat, open or closed.': 'تستقر مسطّحة، مفتوحة أو مغلقة.',
  'Vegetable-tanned lambskin': 'جلد حمل مدبوغ نباتيًا',
  'Softens with wear rather than creasing.': 'يلين مع الارتداء بدل أن يتجعّد.',
  'Cupro lining': 'بطانة كوبرو',
  'Slides on over a sleeve.': 'تنزلق بسهولة فوق الكُمّ.',
  'Nothing else on the front.': 'لا شيء غيره على الواجهة.',
  'Rib cuff': 'كُمّ مضلّع',
  ...
  'Held together in long white stitches so it can be tried, pulled apart and corrected before it is sewn. The thread is meant to come out.':
    'تُجمع بغرز بيضاء طويلة لتُجرَّب وتُفكّ وتُصحَّح قبل أن تُخاط. هذا الخيط وُضع ليُنزع.',
  'The chest': 'الصدر',
  'Cloth, horsehair canvas and domette, joined with a pad stitch worked by hand, so the three move on their own and still return to one shape.':
  ...
  'Made in small counts. When a count is finished it is finished; the pattern stays, and is re-issued rather than replaced.':
    'تُصنع بكميات قليلة. وحين تنفد الكمية فقد نفدت؛ يبقى النموذج، ويُعاد إصداره بدل أن يُستبدل.',
  ...
  Grain: 'اتجاه النسيج',
  Knee: 'الركبة',
  'A jacket ends': 'تنتهي السترة',
  'A coat ends': 'ينتهي المعطف',
  'Line drawing of a jacket chest taken apart into three layers, cloth, horsehair canvas and domette, with a close-up of the hand pad stitch.':
    'رسم خطّي لصدر سترة مفكوك إلى ثلاث طبقات: القماش وكانفاس شعر الخيل والدوميت، مع لقطة مقرّبة لغرزة التبطين اليدوية.',
  Domette: 'دوميت',
  'Hair canvas': 'كانفاس الشعر',
  'Roll line': 'خط الانثناء',
  'Pad stitch': 'غرزة التبطين',
  'By hand': 'يدويًا',
  'Line drawing of a seam in cross-section with its allowances pressed open, and the cloth laid over a tailor\'s ham for pressing.':
    'رسم خطّي لدرزة في مقطع عرضي وحوافها مكويّة مفتوحة، والقماش ممدود على وسادة الخيّاط للكيّ.',
  'Seam, in section': 'الدرزة، في مقطع',
  Face: 'الوجه',
  'Allowances, pressed open': 'الحواف، مكويّة مفتوحة',
  Ham: 'وسادة الكيّ',

  // ─── The shop ──────────────────────────────────────────────────────────
  'This season': 'هذا الموسم',
  'The shop — {n} categories, this season and the {index}': 'المتجر — {n} فئات، من هذا الموسم ومن {index}',
  'Shop by category': 'تسوّق حسب الفئة',
  'Shop this season': 'تسوّق هذا الموسم',
  ', {count}, {where}': '، {count}، {where}',
  'in the {index}': 'في {index}',
  'this season': 'هذا الموسم',
